      ...
      >
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 scroll-animate" style={{ transitionDelay: '400ms' }}>
            ...
            <Link
              to="/gallery"
              className="inline-block px-12 py-5 rounded-full bg-white/90 text-indigo-700 border-2 border-indigo-200 font-semibold text-xl shadow-md hover:bg-white hover:scale-105 transition-all duration-200"
            >
              View Gallery
            </Link>
          </div>
